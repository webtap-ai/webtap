...
class TapManager:
    ...
    def load_standard_tap(self, tap_config_params: TapParams):
        ...
        # generating a list of list of examples since (for very unexplainable reason) it looks like in this way GPT returns better results (compared to a list of examples)
